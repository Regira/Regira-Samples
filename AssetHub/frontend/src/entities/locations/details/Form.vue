        ...
        <FormSection :title="$t(config.detailsTitle || '')" :readonly="readonly">
            <div class="row">
                <div class="col-md mb-2">
                    <input v-model="item.title" maxlength="100" :readonly="readonly" class="form-control" />
                    <FormLabel :label="$t('name')" />
                </div>
                <div class="col-md mb-2">
                    <input v-model="item.building" maxlength="150" :readonly="readonly" class="form-control" />
                    <FormLabel :label="$t('location.building')" />
                </div>
                <div class="col-md mb-2">
                    <input v-model="item.room" maxlength="50" :readonly="readonly" class="form-control" />
                    <FormLabel :label="$t('location.room')" />
                </div>
            </div>
            <div class="mb-2">
                <input v-model="item.address" maxlength="250" :readonly="readonly" class="form-control" />
                <FormLabel :label="$t('location.address')" />
            </div>
        </FormSection>

        ...
        <FormSection :title="$t(config.detailsTitle || '')" :readonly="readonly">
            <div class="row">
                <div class="col-md mb-2">
                    <AssetInputSelector v-model="item.asset" v-model:idValue="item.assetId" :readonly="readonly" />
                    <FormLabel :label="$t('asset')" />
                </div>
                <div class="col-md mb-2">
                    <EmployeeInputSelector v-model="item.employee" v-model:idValue="item.employeeId" :readonly="readonly" />
                    <FormLabel :label="$t('employee')" />
                </div>
            </div>
            <div class="row">
                <div class="col-md mb-2">
                    <DateInput v-model="item.assignedDate" :readonly="readonly" />
                    <FormLabel :label="$t('assetAssignment.assignedDate')" />
                </div>
                <div class="col-md mb-2">
                    <DateInput v-model="item.returnedDate" :readonly="readonly" />
                    <FormLabel :label="$t('assetAssignment.returnedDate')" />
                </div>
            </div>
            <div class="mb-2">
                <DescriptionInput v-model="item.notes" :label="$t('assetAssignment.notes')" :readonly="readonly" />
            </div>
        </FormSection>
...
import { Feedback, FormButtonsRow, FormSection, FormLabel, DescriptionInput, DateInput, Icon } from "@regira/modules/vue/ui"

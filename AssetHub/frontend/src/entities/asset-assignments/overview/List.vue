<template>
    <div class="entity-list">
        <div class="row fw-bold border-bottom pb-2">
            ...
            <div class="col d-none d-md-block">{{ $t("asset") }}</div>
            <div class="col">{{ $t("employee") }}</div>
            <div class="col-2 d-none d-lg-block">{{ $t("assetAssignment.assignedDate") }}</div>
            <div class="col-2 d-none d-lg-block">{{ $t("assetAssignment.returnedDate") }}</div>
            <div class="col-auto">

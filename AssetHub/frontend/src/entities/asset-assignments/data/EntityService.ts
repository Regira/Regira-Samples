...
export class EntityService extends EntityServiceBase<Entity> {
    ...
    override toEntity(item: object): Entity {
        ...
        if (typeof (entity as any).assignedDate === "string") entity.assignedDate = new Date((entity as any).assignedDate)
        if (typeof (entity as any).returnedDate === "string") entity.returnedDate = new Date((entity as any).returnedDate)
        return entity
    }
}

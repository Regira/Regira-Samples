...
const api = "/asset-assignments"

const config: IConfig = {
    id: Entity.name,
    key: "AssetAssignment", // TODO: route-name prefix + icon key (conventionally = Entity.name)
    ...
    routePrefix: "asset-assignments", // TODO: URL path segment
    ...
    overviewTitle: "assetAssignments", // camelCase i18n keys (multi-word → e.g. shoppingLists / shoppingList) — add matching entries to public/data/translations.json, or the nav renders the raw key
    detailsTitle: "assetAssignment",
    description: "assetAssignment.description",

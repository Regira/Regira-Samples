        ...
        <FormSection :title="$t(config.detailsTitle || '')" :readonly="readonly">
            <div class="row">
                <div class="col-md mb-2">
                    <input v-model="item.title" maxlength="50" :readonly="readonly" class="form-control" />
                    <FormLabel :label="$t('name')" />
                </div>
                <div class="col-md-auto mb-2">
                    <input type="color" v-model="item.colorHex" :readonly="readonly" class="form-control form-control-color" />
                    <FormLabel :label="$t('assetStatus.color')" />
                </div>
                <div class="col-md-auto mb-2">
                    <input type="number" v-model.number="item.sortOrder" min="0" :readonly="readonly" class="form-control" style="width: 6rem" />
                    <FormLabel :label="$t('assetStatus.sortOrder')" />
                </div>
            </div>
            <div class="mb-2">
                <NullableCheckBox v-model="item.isOperational" id="isOperational" :label="$t('assetStatus.isOperational')" />
            </div>
        </FormSection>

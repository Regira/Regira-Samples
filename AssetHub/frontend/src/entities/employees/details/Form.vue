        ...
        <FormSection :title="$t(config.detailsTitle || '')" :readonly="readonly">
            <div class="row">
                <div class="col-md mb-2">
                    <input v-model="item.firstName" maxlength="80" :readonly="readonly" class="form-control" />
                    <FormLabel :label="$t('employee.firstName')" />
                </div>
                <div class="col-md mb-2">
                    <input v-model="item.lastName" maxlength="80" :readonly="readonly" class="form-control" />
                    <FormLabel :label="$t('employee.lastName')" />
                </div>
            </div>
            <div class="row">
                <div class="col-md mb-2">
                    <input v-model="item.email" type="email" maxlength="150" :readonly="readonly" class="form-control" />
                    <FormLabel :label="$t('employee.email')" />
                </div>
                <div class="col-md mb-2">
                    <input v-model="item.department" maxlength="100" :readonly="readonly" class="form-control" />
                    <FormLabel :label="$t('employee.department')" />
                </div>
                <div class="col-md mb-2">
                    <input v-model="item.jobTitle" maxlength="100" :readonly="readonly" class="form-control" />
                    <FormLabel :label="$t('employee.jobTitle')" />
                </div>
            </div>
            <div class="mb-2">
                <NullableCheckBox v-model="item.isActive" id="isActive" :label="$t('employee.isActive')" />
            </div>
        </FormSection>
...
import { Feedback, FormButtonsRow, FormSection, FormLabel, NullableCheckBox, Icon } from "@regira/modules/vue/ui"

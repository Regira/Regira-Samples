...
const config: IConfig = {
    id: Entity.name,
    key: "Employee", // TODO: route-name prefix + icon key (conventionally = Entity.name)
    ...
    routePrefix: "employees", // TODO: URL path segment
    ...
    overviewTitle: "employees", // camelCase i18n keys (multi-word → e.g. shoppingLists / shoppingList) — add matching entries to public/data/translations.json, or the nav renders the raw key

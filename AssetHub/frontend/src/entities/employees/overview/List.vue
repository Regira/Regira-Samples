<template>
    <div class="entity-list">
        <div class="row fw-bold border-bottom pb-2">
            ...
            <div class="col d-none d-md-block">{{ $t("employee.department") }}</div>
            <div class="col d-none d-lg-block">{{ $t("employee.jobTitle") }}</div>
            <div class="col-auto d-none d-xl-block">{{ $t("employee.isActive") }}</div>
            <div class="col-auto">

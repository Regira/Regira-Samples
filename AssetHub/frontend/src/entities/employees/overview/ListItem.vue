<template>
    <div class="row border-bottom py-2">
        ...
        <div class="col d-none d-lg-block text-truncate">{{ item.jobTitle }}</div>
        <div class="col-auto d-none d-xl-block">
            <span class="badge" :class="item.isActive ? 'text-bg-success' : 'text-bg-secondary'">
                {{ item.isActive ? $t("employee.active") : $t("employee.inactive") }}
            </span>
        </div>

...
const config: IConfig = {
    id: Entity.name,
    key: "Category", // TODO: route-name prefix + icon key (conventionally = Entity.name)
    ...
    routePrefix: "categories", // TODO: URL path segment
    ...
    overviewTitle: "categories", // camelCase i18n keys (multi-word → e.g. shoppingLists / shoppingList) — add matching entries to public/data/translations.json, or the nav renders the raw key

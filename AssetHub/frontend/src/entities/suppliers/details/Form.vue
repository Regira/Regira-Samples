        ...
        <FormSection :title="$t(config.detailsTitle || '')" :readonly="readonly">
            ...
            <div class="row">
                <div class="col-md mb-2">
                    <input v-model="item.contactName" maxlength="100" :readonly="readonly" class="form-control" />
                    <FormLabel :label="$t('supplier.contactName')" />
                </div>
                <div class="col-md mb-2">
                    <input v-model="item.email" type="email" maxlength="150" :readonly="readonly" class="form-control" />
                    <FormLabel :label="$t('supplier.email')" />
                </div>
            </div>
            <div class="row">
                <div class="col-md mb-2">
                    <input v-model="item.phone" maxlength="30" :readonly="readonly" class="form-control" />
                    <FormLabel :label="$t('supplier.phone')" />
                </div>
                <div class="col-md mb-2">
                    <input v-model="item.website" maxlength="200" :readonly="readonly" class="form-control" />
                    <FormLabel :label="$t('supplier.website')" />
                </div>
            </div>
        </FormSection>

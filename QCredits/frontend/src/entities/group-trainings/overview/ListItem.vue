<template>
    <div class="row border-bottom py-2">
        ...
        <div class="col d-none d-md-block text-truncate">{{ formatDate(item.trainingDate) }}</div>
        <div class="col d-none d-lg-block text-truncate">{{ item.location }}</div>
        <div class="col-2 d-none d-xl-block text-truncate">{{ formatCurrency(item.cost) }}</div>

<template>
    <div class="row border-bottom py-2">
        ...
        <div class="col d-none d-md-block text-truncate">{{ item.annualCredits }}</div>
        <div class="col d-none d-md-block text-truncate">{{ item.reservedCredits }}</div>
        <div class="col d-none d-lg-block text-truncate">{{ item.maxCarryOver }}</div>
        <div class="col d-none d-lg-block text-truncate">{{ item.minBalance }}</div>

<template>
    <div class="entity-list">
        <div class="row fw-bold border-bottom pb-2">
            ...
            <div class="col d-none d-md-block">{{ $t("annualCredits") }}</div>
            <div class="col d-none d-md-block">{{ $t("reservedCredits") }}</div>
            <div class="col d-none d-lg-block">{{ $t("maxCarryOver") }}</div>
            <div class="col d-none d-lg-block">{{ $t("minBalance") }}</div>
            <div class="col-auto">

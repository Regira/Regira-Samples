<!-- Owned m2m editor for Article.Categories — each join row is a chip selecting one Category.
     Bind it in the parent Form.vue to the ARRAY: <ArticleCategoryOverview v-model="item.categories" />
...
import type { ArticleCategory } from "./Entity"

const model = defineModel<Array<ArticleCategory>>()

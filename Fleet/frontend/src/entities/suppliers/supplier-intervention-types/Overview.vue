<!-- Owned m2m editor for Supplier.SupportedInterventionTypes — each join row is a chip selecting one InterventionType.
     Bind it in the parent Form.vue to the ARRAY: <SupplierInterventionTypeOverview v-model="item.supportedInterventionTypes" />
...
import type { SupplierInterventionType } from "./Entity"

const model = defineModel<Array<SupplierInterventionType>>()

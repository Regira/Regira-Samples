...
// A join row linking Supplier to InterventionType (back-end `e.Related(x => x.SupportedInterventionTypes)`). Rows are picked
...
export interface SupplierInterventionType {
    id?: number
...
export type Entity = SupplierInterventionType

<template>
    <div class="row border-bottom py-2 align-items-center">
        ...
        <div class="col d-none d-xl-block text-truncate">{{ formatDate(item.dueDate) }}</div>
        <div class="col-2 text-truncate text-end fw-semibold">{{ formatCurrency(item.totalAmount, undefined, "EUR") }}</div>

...
const config: IConfig = {
    ...
    isComplex: false, // flat lookup: title + description + cost + duration, no relations -> modal form

    routePrefix: "intervention-types", // TODO: URL path segment
    ...
    overviewTitle: "interventionTypes", // camelCase i18n keys (multi-word → e.g. shoppingLists / shoppingList) — add matching entries to public/data/translations.json, or the nav renders the raw key

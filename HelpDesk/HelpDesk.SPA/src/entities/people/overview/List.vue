<template>
    <div class="entity-list">
        <div class="row fw-bold border-bottom pb-2">
            ...
            <div class="col d-none d-md-block">{{ $t("email") }}</div>
            <div class="col-1 d-none d-lg-block">{{ $t("role") }}</div>
            <div class="col d-none d-lg-block">{{ $t("supportTeam") }}</div>
            <div class="col-2 d-none d-xl-block">{{ $t("created") }}</div>
            <div class="col-auto">

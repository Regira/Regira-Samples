    ...
    <form @submit.prevent="handleSubmit">
        ...
        <FormSection :title="$t(config.detailsTitle || '')" :readonly="readonly">
            ...
            <div class="mb-2 form-check">
                <input id="isClosed" v-model="item.isClosed" type="checkbox" :disabled="readonly" class="form-check-input" />
                <label for="isClosed" class="form-check-label">{{ $t("isClosed") }}</label>
            </div>
            <div class="mb-2">
                <input v-model="item.colorHex" type="color" :readonly="readonly" class="form-control form-control-color" />

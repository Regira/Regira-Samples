<template>
    <div class="row border-bottom py-2">
        ...
        <div class="col text-truncate">
            <span v-if="item.colorHex" class="color-dot me-1" :style="{ backgroundColor: item.colorHex }"></span>
            {{ item.$title }}
        </div>
        <div class="col d-none d-md-block text-truncate">{{ item.description }}</div>

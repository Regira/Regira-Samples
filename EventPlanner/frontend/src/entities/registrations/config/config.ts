...
const config: IConfig = {
    id: Entity.name,
    key: "Registration", // TODO: route-name prefix + icon key (conventionally = Entity.name)
    ...
    routePrefix: "registrations", // TODO: URL path segment
    ...
    overviewTitle: "registrations", // camelCase i18n keys (multi-word → e.g. shoppingLists / shoppingList) — add matching entries to public/data/translations.json, or the nav renders the raw key
    detailsTitle: "registration",

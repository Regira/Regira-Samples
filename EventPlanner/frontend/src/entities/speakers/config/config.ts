...
const config: IConfig = {
    id: Entity.name,
    key: "Speaker", // TODO: route-name prefix + icon key (conventionally = Entity.name)
    ...
    routePrefix: "speakers", // TODO: URL path segment
    ...
    overviewTitle: "speakers", // camelCase i18n keys (multi-word → e.g. shoppingLists / shoppingList) — add matching entries to public/data/translations.json, or the nav renders the raw key
    detailsTitle: "speaker",
    description: "speaker.description",
    icon: "bi bi-mic-fill",

    defaultPageSize: 12, // card grid — a multiple of the common 2/3/4-per-row breakpoints

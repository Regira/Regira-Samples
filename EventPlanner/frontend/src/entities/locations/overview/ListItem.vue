<template>
    <div class="row border-bottom py-2 align-items-center">
        ...
        <div class="col d-none d-md-block text-truncate">{{ item.city }}</div>
        <div class="col d-none d-lg-block text-truncate">{{ item.country }}</div>
        <div class="col-2 d-none d-lg-block text-end">
            <span class="badge rounded-pill text-bg-light border"><Icon name="bi bi-people-fill" class="me-1" />{{ item.capacity }}</span>
        </div>

...
const config: IConfig = {
    id: Entity.name,
    key: "Venue", // TODO: route-name prefix + icon key (conventionally = Entity.name)
    ...
    routePrefix: "locations", // TODO: URL path segment
    ...
    overviewTitle: "venues", // camelCase i18n keys (multi-word → e.g. shoppingLists / shoppingList) — add matching entries to public/data/translations.json, or the nav renders the raw key
    detailsTitle: "venue",

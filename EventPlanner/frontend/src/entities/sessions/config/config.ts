...
const config: IConfig = {
    id: Entity.name,
    key: "Session", // TODO: route-name prefix + icon key (conventionally = Entity.name)
    ...
    routePrefix: "sessions", // TODO: URL path segment
    ...
    overviewTitle: "sessions", // camelCase i18n keys (multi-word → e.g. shoppingLists / shoppingList) — add matching entries to public/data/translations.json, or the nav renders the raw key
    detailsTitle: "session",
    description: "session.description",
    icon: "bi bi-calendar-event-fill",

    defaultPageSize: 20, // agenda-style rows — a taller page reads better than deep pagination

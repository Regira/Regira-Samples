...
const api = "/meeting-rooms"

const config: IConfig = {
    id: Entity.name,
    key: "MeetingRoom",
    isComplex: true, // carries a relation to Floor plus several fields - use the Details page

    routePrefix: "meeting-rooms",
    baseQueryParams: {},
    initialQuery: {},

    overviewTitle: "meetingRooms",
    detailsTitle: "meetingRoom",

<template>
    ...
    <form @submit.prevent="handleSubmit">
        ...
        <FormSection :title="$t(config.detailsTitle || '')" :readonly="readonly">
            ...
            <div class="mb-2">
                <input v-model="item.email" type="email" :readonly="readonly" class="form-control" required />
                <FormLabel :label="$t('email')" />
            </div>
            <div class="row">
                <div class="col-md mb-2">
                    <input v-model="item.department" :readonly="readonly" class="form-control" />
            ...
            <div class="mb-2">
                <NullableCheckBox v-model="item.isActive" id="employee-isActive" :label="$t('isActive')" :readonly="readonly" />
            </div>
        </FormSection>

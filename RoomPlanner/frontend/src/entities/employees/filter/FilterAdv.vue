<template>
    <div class="adv-filter">
        ...
        <input v-model.lazy.trim="searchObject.department" class="form-control mb-2" :placeholder="$t('department')" @change="handleUpdate" />
        <NullableCheckBox v-model="searchObject.isActive" id="isActive" :label="$t('isActive')" class="mb-2" @update:modelValue="handleUpdate" />
    </div>
</template>

<template>
    ...
    <form @submit.prevent="handleSubmit">
        ...
        <FormSection :title="$t(config.detailsTitle || '')" :readonly="readonly">
            <div class="mb-2">
                <BuildingInputSelector v-model="item.building" v-model:idValue="item.buildingId" :readonly="readonly" />
            </div>
            <div class="row">
                ...
                <div class="col-md mb-2">
                    <input type="number" v-model.number="item.level" :readonly="readonly" class="form-control" />

        ...
        <FormSection :title="$t(config.detailsTitle || '')" :readonly="readonly">
            ...
            <div class="row">
                <div class="col-md mb-2">
                    <input v-model="item.address" :readonly="readonly" class="form-control" required />
                    <FormLabel :label="$t('address')" />
                </div>
                <div class="col-md mb-2">
                    <input v-model="item.city" :readonly="readonly" class="form-control" required />
...
import { Feedback, FormButtonsRow, FormSection, FormLabel, Icon, DescriptionInput } from "@regira/modules/vue/ui"
